<%@ Page Title="" Language="C#" MasterPageFile="~/RegistrationMasterPage.master" AutoEventWireup="true" CodeFile="RootUserLogin.aspx.cs" Inherits="RootLogin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 col-lg-4 bg-light" style="margin-top: 3%; padding: 2%">
                <h2 class="card-title " style="text-align: center">Root Login</h2>
                <div class="form-group ">
                    ...
                    <asp:RegularExpressionValidator runat="server" ControlToValidate="txtemail" SetFocusOnError="True" Text="Email is not valid" ForeColor="red" ValidationExpression="\w+([-+.]\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"></asp:RegularExpressionValidator>
